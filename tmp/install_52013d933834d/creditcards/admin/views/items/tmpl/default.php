...
<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible"><?php echo JText::_('COM_creditcards_ITEMS_SEARCH_FILTER');?></label>
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_creditcards_ITEMS_SEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_creditcards_ITEMS_SEARCH_FILTER'); ?>" />
			</div>
		...
		<table class="table table-striped" id="itemsList">
			...
			foreach ($this->items as $i => $item) :
				...
				$canChange  = $user->authorise('core.edit.state', 'com_creditcards') && $canCheckin;
