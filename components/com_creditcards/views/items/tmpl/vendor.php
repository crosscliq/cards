  ...
  <tr>
    <td align="center" valign="top"><table width="90%" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="300" cellspacing="8" cellpadding="8">
        <tbody><tr>
          <td align="center" valign="middle" bgcolor="#4c1546"><a  href="<?php echo JURI::current(); ?>/att" class="MAINnav">American Express</a></td>
        </tr>
        <tr>
          <td align="center" valign="middle" bgcolor="#4c1546"><a href="<?php echo JURI::current(); ?>/verizon" class="MAINnav">Chase</a></td>
        </tr>
        <tr>
          <td align="center" valign="middle" bgcolor="#4c1546"><a href="<?php echo JURI::current(); ?>/tmobile" class="MAINnav">Other</a></td>
        </tr>
       <!-- <tr>
